...
for aerogenerador in aerogeneradores:
    ...
    ganancia_aerogeneradores.append(profits)
...
for df, aerogenerador in zip (ganancia_aerogeneradores, aerogeneradores):
    df.to_excel(Excelwriter, sheet_name=aerogenerador,index=False)
